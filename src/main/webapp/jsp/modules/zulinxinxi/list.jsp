...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">租赁信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>租赁信息管理</span></li>
								<li class="breadcrumb-item active"><span>租赁信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">租赁信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="cheliangkuanshiSearch" class="form-control form-control-sm" placeholder="请输入车辆款式" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#cheliangkuanshiSearch').val() != null && $('#cheliangkuanshiSearch').val() != ''){
				searchForm.cheliangkuanshi ="%" +  $('#cheliangkuanshiSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'cheliangguihai','是','','')");
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("zulinxinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("zulinxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zulinxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zulinxinxi");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"zulinxinxi");
