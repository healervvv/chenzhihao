...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑车辆归还</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑车辆归还</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">车辆归还信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>车辆款式</label>
										<input name="cheliangkuanshi" id="cheliangkuanshi" name="cheliangkuanshi" class="form-control" placeholder="车辆款式">
									</div>
									<div class="form-group col-md-6">
										<label>归还时间</label>
										<div id="guihaishijianDate" class="input-append date form_datetime">
											<input id="guihaishijian-input" name="guihaishijian" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>归还备注</label>
										<input name="guihaibeizhu" id="guihaibeizhu" name="guihaibeizhu" class="form-control" placeholder="归还备注">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "cheliangguihai/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("cheliangguihai/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("cheliangguihai/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#cheliangkuanshi").val(ruleForm.cheliangkuanshi);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.cheliangkuanshi != null && res.data.cheliangkuanshi != ''){
						...
						$("#cheliangkuanshi").val(res.data.cheliangkuanshi);
						$("#cheliangkuanshi").attr('readonly','readonly');
					}
